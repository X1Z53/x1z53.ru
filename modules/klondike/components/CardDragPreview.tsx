...
const createPreviewCards = (draggedCard: PlayingCard | null, stacks: PlayingCard[][]): PlayingCard[] => {
  if (!draggedCard) return []

  const indexOfCard = stacks[draggedCard.index].findIndex(card => card.id === draggedCard.id)
