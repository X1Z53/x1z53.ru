...
export default function FileReaderComponent() {
  const { columnButtons, rowButtons, fileTitle, valueTitle } = getLocaled({
    ru: {
      ...
      fileTitle: "File",
      valueTitle: "Выберите или перетащите файлы сюда"
    },
    en: {
      ...
      fileTitle: "File",
      valueTitle: "Choose or drag and drop files here"
    }
  })
  ...
  return <PageGenerator {...getDatabaseObject(getLocaled(fileReaders), "table")} >
